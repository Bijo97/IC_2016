<?php
    ...
    if ($row['ktm1'] == NULL || $row['ktm2'] == NULL || $row['ktm3'] == NULL){
        header("Location: upload_kartu.php");
    }
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Preview Foto Katu Pelajar</title>
...
<body>
    ...
    <div class="panel-heading">
        <h2 style="color: green; text-align: center;">Semua foto kartu pelajar sudah diupload</h2><br>
    </div>
    <div class="panel-body">
        <table>
            <tr><td><center><?php echo "<img src='kartu_pelajar/".$row['foto1']."jpg'>"; ?></center><br></td></tr>
            <tr><td><center><?php echo "<img src='kartu_pelajar/".$row['foto2']."jpg'>"; ?></center><br></td></tr>
            <tr><td><center><?php echo "<img src='kartu_pelajar/".$row['foto3']."jpg'>"; ?></center><br></td></tr>
        </table>
    </div>
</div>
        </div>
