	...
	<div class="panel-body">				
		<form class="form-horizontal" role="form" method="POST" action="send.php">
			...
			<div class="form-group">
				...
				<label class="control-label"><?php if ($row['alergi1'] == NULL){echo "Tidak ada";} else {echo $row['alergi1'];} ?></label>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-md-6 control-label">Alergi:</label>
				<label class="control-label"><?php if ($row['alergi2'] == NULL){echo "Tidak ada";} else {echo $row['alergi2'];} ?></label>
			</div>
			<div class="form-group">
				<label class="col-md-6 control-label">Penyakit:</label>
			...
			<div class="form-group">
				<label class="col-md-6 control-label">Alergi:</label>
				<label class="control-label"><?php if ($row['alergi3'] == NULL){echo "Tidak ada";} else {echo $row['alergi3'];} ?></label>
			</div>
			<div class="form-group">
				<label class="col-md-6 control-label">Penyakit:</label>
