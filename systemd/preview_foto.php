...
<body>
    ...
    <div class="panel-heading">
        <h2 style="color: green; text-align: center;">Semua foto sudah diupload</h2><br>
    </div>
    <div class="panel-body">
        <table>
            <tr><td><center><?php echo "<img src='foto/".$row['foto1']."jpg'>"; ?></center><br></td></tr>
            <tr><td><center><?php echo "<img src='foto/".$row['foto2']."jpg'>"; ?></center><br></td></tr>
            <tr><td><center><?php echo "<img src='foto/".$row['foto3']."jpg'>"; ?></center><br></td></tr>
        </table>
    </div>
</div>
        </div>
