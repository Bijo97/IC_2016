<?php
    ...
    if (!($row['foto1'] == NULL || $row['foto2'] == NULL || $row['foto3'] == NULL)){
        header("Location: preview_foto.php");
    }
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Upload Foto Peserta</title>
...
<style>
    ...
    <div class="panel-heading"><h3><center>Upload Foto Peserta</center></h3>
    </div>
    <div class="panel-body">
            <form method="POST" action="upload.php">
                <div class="form-group">
                    <!--<input id="file-5" class="file" type="file" name="photo[]" accept=".jpg,.jpeg,.png,.svg" multiple data-preview-file-type="any" data-upload-url="upload.php">-->
                    Foto anggota pertama: 
                    <?php
                        if ($row['foto1'] == NULL){
                            echo "<input type='file' name='photo[]' id='foto1'>";
                        } else {
                            echo "Foto anggota pertama sudah diupload";
                        }
                    ?>
                </div><br>
                <div class="form-group">
                    ...
                    <?php
                        if ($row['foto2'] == NULL){
                            echo "<input type='file' name='photo[]' id='foto2'>";
                        } else {
                            echo "Foto anggota kedua sudah diupload";
                        }
                    ?>
                </div><br>
                <div class="form-group">
                    ...
                    <?php
                        if ($row['foto3'] == NULL){
                            echo "<input type='file' name='photo[]' id='foto3'>";
                        } else {
                            echo "Foto anggota ketiga sudah diupload";
                        }
                    ?>
                </div><br>
                <div class="form-group"> 
