...
<body>
		...
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
				<ul class="nav navbar-nav">
					<li class="active"><a href="simpleadmin.php">Menu Utama</a></li>
					<li>
						<?php
	...
	<div class="panel-heading">
		Selamat, Anda Berhasil Login Website Industrial Compettition 2016
	</div>
	<div class="panel-body">
		Dimohon untuk mengisi data-data yang di perlukan pada bagian Tab pengisian data
	</div>
</div>
  		</div>
